# GSA Development Guide

Comprehensive technical documentation for developing, training, and evaluating Gated Sparse Attention models.
...
- [Quick Start Guide](README-quickstart.md) - Get up and running quickly
